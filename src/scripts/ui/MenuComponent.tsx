...
import { runBuildApartments, runBuildCondos, runBuildOxfordUniAndAtomium, runInitialMines } from "../DavesMods";
         ...
         <div className="menus">
            ...
            >
               ...
               >
                  ...
                  >
                     <MenuItem check={false}>Oxford Uni and Atomium</MenuItem>
                  </div>
               </div>
            </div>
            {isHalloween(now) ? (
